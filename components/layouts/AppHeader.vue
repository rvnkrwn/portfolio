<template>
  <div>
    <div id="highlight" class="invisible md:visible fixed z-[99999] h-12 w-12 rounded-full border border-base-content" />
    <header class="fixed z-[9999] w-full h-fit overflow-hidden">
      ...
      <nav class="wrapper items-center !h-full left-0 relative hidden overflow-hidden  p-[1em] md:p-[2em]">
        ...
        <ul class="text-5xl -mt-28 protest-guerrilla-regular tracking-wider font-extrabold md:text-7xl md:font-black">
          <li class="nav-item">
            <NuxtLink active-class="nav-link-active" class="nav-link opacity-70" to="/">
              Home
            </NuxtLink>
          </li>
          <li class="nav-item">
            <NuxtLink active-class="nav-link-active" class="nav-link opacity-70" to="/aboutMe">
              About Me
            </NuxtLink>
          </li>
          <li class="nav-item">
            <NuxtLink active-class="nav-link-active" class="nav-link opacity-70" to="/experiences">
              Experiences
            </NuxtLink>
          </li>
          <li class="nav-item">
            <NuxtLink active-class="nav-link-active" class="nav-link opacity-70" to="/skills">
              Skills
            </NuxtLink>
          </li>
          <li class="nav-item">
            <NuxtLink active-class="nav-link-active" class="nav-link opacity-70" to="/blogs">
              Blogs
            </NuxtLink>
          </li>
          <li class="nav-item">
            <NuxtLink active-class="nav-link-active" class="nav-link opacity-70" to="/contacts">
              Contacts
            </NuxtLink>
          </li>
        </ul>
        <ul class="absolute bottom-32 right-2 grid gap-2 border-base-content/70 p-1 border-r-2 grid-cols-1">
          <li>
            <NuxtLink to="https://instagram.com/rvnkrwn" class="nav-link opacity-70">
              <Icon icon="mdi:instagram" width="36" height="36" />
            </NuxtLink>
          </li>
          <li>
            <NuxtLink to="https://github.com/rvnkrwn" class="nav-link opacity-70">
              <Icon icon="mdi:github" width="36" height="36" />
            </NuxtLink>
          </li>
          <li>
            <NuxtLink to="https://www.linkedin.com/in/rvnkrwn/" class="nav-link opacity-70">
              <Icon icon="mdi:linkedin" width="36" height="36" />
            </NuxtLink>
          </li>
          <li>
            <NuxtLink to="https://codepen.io/rvnkrwn" class="nav-link opacity-70">
              <Icon icon="mdi:codepen" width="36" height="36" />
            </NuxtLink>
          </li>
          <li>
            <NuxtLink to="mailto:rvnkrwn@gmail.com" class="nav-link opacity-70">
